        ...
        <div class="manage-page manage-page--pricing-plans manage-page--promote">
            <div class="manage-page-header">
                ...
                <div class="manage-page-header__subtitle">
                    You can promote your equipment post and bring it to the top of the search list, select pricing plan to get
                    more promotions or post for free.
                </div>
            </div>
            <form
                action="{{ route('seller.store.equipment.plan', $equipment->id) }}"
                method="post"
            >
                @csrf
...
{{--                    @if ($user->user_plan && $user->canUseFeature($feature) && is_employer())--}}
{{--                        --}}{{--                @if(!empty($user_plan))--}}
{{--                        @php--}}
...
{{--                                    @if($user->user_plan && array_key_exists('equipment-sponsored', $user->user_plan->features))--}}
{{--                                    <ul><li><span>{{ __('sponsored equipment - (:equipment remains per your plan)', ['equipment' => $user->user_plan->features['equipment-sponsored']]) }}</span></li></ul>--}}
{{--                                    @endif--}}
{{--                                </div>--}}
