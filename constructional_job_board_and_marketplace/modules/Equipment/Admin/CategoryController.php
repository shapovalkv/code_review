...
class CategoryController extends AdminController
{
    ...
    public function __construct()
    {
        ...
        $this->categoryClass = EquipmentCategory::class;
    }
    ...
    public function index(Request $request)
    {
        ...
        return view('Equipment::admin.category.index', $data);
    }
    ...
    public function edit(Request $request, $id)
    {
        ...
        if (empty($row)) {
            return redirect(route('equipment.admin.category.index'));
        }
        ...
        return view('Equipment::admin.category.detail', $data);
    }
