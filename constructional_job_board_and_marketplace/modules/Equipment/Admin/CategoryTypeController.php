...
use Modules\Equipment\Models\EquipmentCategoryTranslation;
use Modules\Equipment\Models\EquipmentCategoryType;
...
class CategoryTypeController extends AdminController
{
    ...
    public function __construct()
    {
        ...
        $this->categoryClass = EquipmentCategoryType::class;
    }
    ...
    public function index(Request $request)
    {
        ...
        $data = [
            ...
            'translation' => new EquipmentCategoryTranslation(),
            'breadcrumbs' => [
                [
                    'name' => __('equipments'),
        ...
        return view('Equipment::admin.category_type.index', $data);
    }
    ...
    public function edit(Request $request, $id)
    {
        ...
        if (empty($row)) {
            return redirect(route('equipment.admin.category_type.index'));
        }
        ...
        return view('Equipment::admin.category_type.detail', $data);
    }
