...
class EquipmentTag extends BaseModel
{
    protected $table = 'bc_equipment_tags';
    protected $fillable = [
        'target_id',
        'tag_id'
    ];
    ...
    public static function getTags()
    {
        ...
        return $query
            ->join('bc_equipment_tags as nt', 'nt.tag_id', '=', 'core_tags.id')->orderByRaw('RAND()')
