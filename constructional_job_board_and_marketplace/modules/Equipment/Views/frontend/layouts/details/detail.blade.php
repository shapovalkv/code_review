...
<div class="overview mb-4">
    <h4 class="mb-4">{{ __("About This equipment") }}</h4>
    <p>
        <?php echo $translation->content ?>
    </p>
</div>

@include('equipment::frontend.layouts.details.profile-card')

@include('equipment::frontend.layouts.details.compare-packages')

@if(!empty($row->video_url))
    <div class="video-outer">
        <h4>{{ __("equipment Video") }}</h4>
        <div class="video-box">
            <figure class="image">
...
@include('equipment::frontend.layouts.details.faqs')
...
@include('equipment::frontend.layouts.details.related')
