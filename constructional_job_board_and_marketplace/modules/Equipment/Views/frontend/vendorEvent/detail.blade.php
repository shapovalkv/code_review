...
@section('content')
    ...
    <div class="lang-content-box">
        <form action="{{route('equipment.vendor.store',['id'=>($row->id) ? $row->id : '-1','lang'=>request()->query('lang')])}}" method="post">
            @csrf
            <div class="form-add-service">
                ...
                <div class="tab-content" id="nav-tabContent">
                    <div class="tab-pane fade show active" id="nav-tour-content">
                        @include('equipment::admin/event/content')
                        @if(is_default_lang())
                    ...
                    <div class="tab-pane fade" id="nav-tour-location">
                        @include('equipment::admin/event/location',["is_smart_search"=>"1"])
                    ...
                    <div class="tab-pane fade" id="nav-tour-pricing">
                        ...
                        @include('equipment::admin/event/pricing')
                    </div>
                    @if(is_default_lang())
                        <div class="tab-pane fade" id="nav-attribute">
                            @include('equipment::admin/event/attributes')
                        </div>
                    @endif
                </div>
            </div>
