...
>
    <div class="manage-page-header">
        <div class="manage-page-header__title-wrap">
            <h3 class="manage-page-header__title">{{ __("My Equipment") }}</h3>
            {{--            TODO change numbers to real    --}}
            <div class="manage-page-header__subtitle">{{ __("20 total slots  / 6 available") }}</div>
        </div>
        ...
        <div class="manage-page-header__sort">
            <div class="manage-page-header__sort-top">
                ...
                <div class="manage-page-header__sort-btns">
                    <a
                        href="{{ route('seller.equipment.export') }}"
                        target="_blank"
                ...
                <div class="manage-page__items">
                    <template v-if="items.length > 0">
                        <job-item-dashboard
                            ...
                            statuses-request-path=""
                            thirty-prop="Contacts"
                            type="equipment"
                    ...
                    <div v-else class="manage-page__items">
                        <div class="manage-page__items-empty">
                            <div class="manage-page__items-empty-title">you do not sell equipment</div>

                            <a
                                href="{{ route('seller.equipment.create') }}"
...
@section('footer')
    <script src="{{ mix('js/manageEquipment.js', $manifestDir) }}"></script>
@endsection
