...
<div class="bc-equipment-order-details">
    <div class="container">
            ...
            <div class="col-order-left">
                <div class="default-tabs style-two tabs-box">
                    <ul class="tab-buttons clearfix">
                        ...
                        @if(!empty($order->equipment->requirements) || !empty($order->requirements))
                ...
                @includeIf("equipment::frontend.buyer.order.tab." . $tab)

            </div>
            @if($order->equipment)
                @php
                $disableCountdown = false;
                    if($order->status == \Modules\equipment\Models\equipmentOrder::COMPLETED || $order->status == \Modules\equipment\Models\equipmentOrder::CANCELLED || $order->status == \Modules\equipment\Models\equipmentOrder::INCOMPLETE){
                ...
                <div class="col-order-right {{ !$disableCountdown ? 'has-countdown' : '' }}">
                    <div class="sticky-order-right">
                        ...
                        @includeWhen(!$disableCountdown,"equipment::frontend.elements.order-countdown")

                        @include("equipment::frontend.elements.order-overview")
                    </div>
...
@section('footer')
    <script type="text/javascript" src="{{ asset('module/equipment/js/equipment-order.js?_ver='.config('app.version')) }}"></script>
