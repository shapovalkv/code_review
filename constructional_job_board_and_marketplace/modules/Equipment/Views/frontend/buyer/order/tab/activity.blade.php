@php
    ...
    $delivery_count = 0;
@endphp
<div class="bc-order-panel @if($order->status == \Modules\equipment\Models\equipmentOrder::COMPLETED || $order->status == \Modules\equipment\Models\equipmentOrder::CANCELLED) bc-order-completed @endif">
        ...
        @if($order->activities)
            @foreach($order->activities as $key => $activity)
                ...
                @switch($activity['type'])
                    @case(\Modules\equipment\Models\equipmentOrderActivity::TYPE_REQUIREMENTS)
                        ...
                        @break
                    @case(\Modules\equipment\Models\equipmentOrderActivity::TYPE_ORDER_STARTED)
                        ...
                        @break
                    @case(\Modules\equipment\Models\equipmentOrderActivity::TYPE_DELIVERY_DATE)
                        ...
                        @break
                    @case(\Modules\equipment\Models\equipmentOrderActivity::TYPE_DELIVERED)
                        ...
                        <div id="activity-{{ $activity->id }}" class="activity-item delivered">
                            ...
                            <div class="item-body">
                                ...
                                <div class="message-body">
                                    @include('equipment::frontend.elements.delivery-item')
                                </div>
                            </div>
                        </div>
                        @break
                    @case(\Modules\equipment\Models\equipmentOrderActivity::TYPE_REVISION)
                                            ...
                                            <div class="activity-item user-message">
                                                ...
                                                <div class="item-body">
                                                    ...
                                                    <div class="message-body">
                                                        ...
                                                        @include('equipment::frontend.elements.attachments')
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                        ...
                        @break
                    @case(\Modules\equipment\Models\equipmentOrderActivity::TYPE_ORDER_COMPLETED)
    ...
    @if($order->status == \Modules\equipment\Models\equipmentOrder::COMPLETED || $order->status == \Modules\equipment\Models\equipmentOrder::CANCELLED)
...
@if($order->status == \Modules\equipment\Models\equipmentOrder::DELIVERED)
    <div class="button-group text-center mt-4">
        ...
        @if(!$order->orderExpired())
            ...
            @include('equipment::frontend.elements.revision-popup')
        @endif
    </div>
@endif
