...
use App\Listeners\SendChatMessageToMailListener;
...
use Modules\User\Listeners\SendNotifyFillProfile;
use Modules\User\Listeners\SendNotifyRegistered;
use Modules\User\Listeners\SendNotifyRegisteredListen;
use Modules\User\Listeners\SendNotifyUserVerificationEmail;
...
class EventServiceProvider extends ServiceProvider
{
    ...
    protected $listen = [
        ...
        SendMailUserRegistered::class => [
            ...
            SendNotifyUserVerificationEmail::class
        ],
        Verified::class => [
            SendNotifyFillProfile::class
        ],
