...
class ChatMessagesScreen extends Component
{
    ...
    protected $listeners = ['messagesLoaded', 'onScreenChanged', 'addNewMessage', 'removeUpload', 'onChatHistoryClear', 'onChatDelete', 'Recalculate'];
    ...
    {
        return view('livewire.chat-messages-screen');
    }
