...
class NotificationController extends Controller
{
    ...
    public function index(NotificationService $notificationService)
    {
        return view('notifications', [
            'unreadNotifications' => $notificationService->getUnreadNotifications(auth()->user()),
    ...
    public function markNotification(Request $request, NotificationService $notificationService)
    {
        ...
        $notificationService->markNotification(auth()->user(), $request);

        return back()->with('success', __('messages.notification_mark_as_read'));
    }
