<x-app-layout>
                <div class="row g-3 mb-3">
                    <div class="col-md-6 col-xxl-3">
                        <div class="card h-md-100 ecommerce-card-min-width">
                            ...
                            <div class="card-body d-flex flex-column justify-content-end">
                                <div class="row">
                                    <div class="col">
                                        <p class="font-sans-serif lh-1 mb-1 fs-4">{{ $totalProjects }}</p>
                                    </div>
                    ...
                    <div class="col-md-6 col-xxl-3">
                        <div class="card h-md-100">
                            <div class="card-header pb-0">
                                <h6 class="mb-0 mt-2">Total Active Subscriptions</h6>
                            </div>
                            <div class="card-body d-flex flex-column justify-content-end">
                                <div class="row justify-content-between">
                                    <div class="col-auto align-self-end">
                                        <div class="fs-4 fw-normal font-sans-serif text-700 lh-1 mb-1">{{$totalActiveSubscriptions}}</div>
                                    </div>
                            ...
                            <div class="card-header">
                                <div class="row flex-between-end">
                                    <div class="col-auto align-self-center">
                                        <h5 class="mb-0" data-anchor="data-anchor">Revenue Chart</h5>
                                    </div>
                                    <div class="col-auto ms-auto">
                                        <div class="nav nav-pills nav-pills-falcon flex-grow-1" role="tablist">
                                            <select class="form-select form-select-sm" name="year" id="dropdown_year_chart">
                                                @foreach($years as $year)
                                                    <option value="{{$year}}" @if ($year == $selectedYear) selected="selected" @endif>
                                                        {{$year}}
                                                    </option>
                                                @endforeach
                                            </select>
    ...
    @push("scripts")
        <script type="module">
            ...
            $(document).on('change', '#dropdown_year_chart', function () {
