...
//                    'duration'=>1,
//                    'duration_type'=>'month',
//                    'annual_price'=> !empty($prices[$k]) ? $prices[$k] + 1000 : '',
...
//            }
            ...
            DB::table('core_settings')->insert([
                [
                    ...
                    'val'   => 'Employers Pricing Packages',
                    'group' => 'user_plans'
                ],
                [
                ...
                DB::table('core_settings')->insert(
                    [
                        ...
                        'val'   => '<h1 style="text-align: center;">Welcome!</h1>
                            ...
                            <p>Thank you for signing up with Mental Healthcare Careers! We hope you enjoy your time with us.</p>
                            <p>Regards,</p>
                            <p>Mental Healthcare Careers</p>',
                        'group' => 'vendor'
                    ]
                );
            }
