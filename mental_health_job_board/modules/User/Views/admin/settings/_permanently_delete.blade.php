...
<div class="row mt-4">
    <div class="col-sm-4">
        ...
        <div class="form-group-desc">{{ __('Content email verify send when user permanently deleted.')}}
            @foreach(\Modules\User\Emails\UserPermanentlyDelete::CODE_CANDIDATE as $item=>$value)
                <div><code>{{$value}}</code></div>
            @endforeach
        </div>
        <div class="form-group-desc">{{ __('Content email verify send when company permanently deleted.')}}
            @foreach(\Modules\User\Emails\UserPermanentlyDelete::CODE_COMPANY as $item=>$value)
                <div><code>{{$value}}</code></div>
            @endforeach
        </div>
    </div>
    <div class="col-sm-8">
        ...
        <div class="panel" data-condition="user_enable_permanently_delete_email:is(1)">
            <div class="panel-title"><strong>{{__("To candidate")}}</strong></div>
            <div class="panel-body">
                <div class="form-group" >
        ...
        <div class="panel" data-condition="user_enable_permanently_delete_email:is(1)">
            <div class="panel-title"><strong>{{__("To admin about candidate")}}</strong></div>
            <div class="panel-body">
                <div class="form-group" >
                    <label>{{__("Subject")}}</label>
                    <div class="form-controls">
        ...
        <div class="panel" data-condition="user_enable_permanently_delete_email:is(1)">
            <div class="panel-title"><strong>{{__("To company")}}</strong></div>
            <div class="panel-body">
                <div class="form-group" >
                    <label>{{__("Subject")}}</label>
                    <div class="form-controls">
                        <input type="text" name="company_permanently_delete_subject_email" class="form-control"  value="{{setting_item_with_lang('company_permanently_delete_subject_email',request()->query('lang')) ?? '' }}">
                    </div>
                </div>
                <div class="form-group" >
                    ...
                    <label>{{__("Content")}}</label>
                    <div class="form-controls">
                        <textarea name="company_permanently_delete_content_email" class="d-none has-ckeditor" cols="30" rows="10">{{setting_item_with_lang('company_permanently_delete_content_email',request()->query('lang')) ?? '' }}</textarea>
                    </div>
                </div>
        ...
        <div class="panel" data-condition="user_enable_permanently_delete_email:is(1)">
            <div class="panel-title"><strong>{{__("To admin about company")}}</strong></div>
            <div class="panel-body">
                <div class="form-group" >
                    <label>{{__("Subject")}}</label>
                    <div class="form-controls">
                        <input type="text" name="company_permanently_delete_subject_email_to_admin" class="form-control"  value="{{setting_item_with_lang('company_permanently_delete_subject_email_to_admin',request()->query('lang')) ?? '' }}">
                    </div>
                </div>
                <div class="form-group" >
                    ...
                    <label>{{__("Content")}}</label>
                    <div class="form-controls">
                        <textarea name="company_permanently_delete_content_email_to_admin" class="d-none has-ckeditor" cols="30" rows="10">{{setting_item_with_lang('company_permanently_delete_content_email_to_admin',request()->query('lang')) ?? '' }}</textarea>
                    </div>
                </div>
