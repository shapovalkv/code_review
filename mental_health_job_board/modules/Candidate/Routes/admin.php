...
Route::get('/export','CandidateController@export')->name('candidate.admin.export');
...
Route::post('/getInviteMessage','CandidateController@getCandidateInviteMessage')->name('candidate.admin.getInviteMessage');
