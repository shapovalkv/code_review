                ...
                <div class="row">
                    ...
                    <div class="form-group col-lg-4 col-md-12 col-sm-12">
                        ...
                        <input type="text" name="s" value="{{ request()->input('s') }}"
                               placeholder="{{ __("Candidate title...") }}">
                    </div>
...
{{--                                <a href="{{ ($candidate_sidebar_cta->button->url) }}"--}}
{{--                                   target="_{{ $candidate_sidebar_cta->button->target ?? "self" }}"--}}
{{--                                   class="theme-btn btn-style-one bg-blue">--}}
{{--                                    <span--}}
{{--                                        class="btn-title">{{ $candidate_sidebar_cta->button->name ?? __("Start Recruiting Now") }}</span>--}}
{{--                                </a>--}}
{{--                            @endif--}}
{{--                            <div class="image"--}}
{{--                                 style="background-image: url({{ !empty($candidate_sidebar_cta->image) ? \Modules\Media\Helpers\FileHelper::url($candidate_sidebar_cta->image, 'full') : '' }});"></div>--}}
{{--                        </div>--}}
{{--                        <!-- End Call To Action -->--}}
{{--                    @endif--}}
                </div>
