...
class RouteServiceProvider extends ServiceProvider
{
     ...
     * @var string
     */
    protected $moduleNamespace = 'Modules\MarketplaceUser\Controllers';

    protected $adminModuleNamespace = 'Modules\MarketplaceUser\Admin';
    ...
    protected function mapAdminRoutes()
    {
        Route::middleware(['web','dashboard'])
            ...
            ->prefix('admin/module/marketplace_user')
