        ...
        <div class="row">
            <div class="col-md-4 mb40">
                <div class="panel">
                    ...
                    <div class="panel-body">
                        <form action="{{route('marketplace_user.admin.category.store',['id'=>-1])}}" method="post">
                            @csrf
                            @include('MarketplaceUser::admin/category/form',['parents'=>$rows])
                            <div class="">
            ...
            <div class="col-md-8">
                <div class="filter-div d-flex justify-content-between ">
                    <div class="col-left">
                        @if(!empty($rows))
                            <form method="post" action="{{url('admin/module/marketplace_user/category/bulkEdit')}}"
                    ...
                    <div class="col-left">
                        <form method="get" action="{{url('/admin/module/marketplace_user/category/')}} " class="filter-form filter-form-right d-flex justify-content-end" role="search">
                            @csrf
                            ...
                            <table class="table table-hover">
                                ...
                                @if(count($rows) > 0)
                                    ...
                                    <tr>
                                        ...
                                        <td class="title">
                                            <a href="{{url('admin/module/marketplace_user/category/edit/'.$row->id)}}">{{$prefix.' '.$translate->name}}</a>
                                        </td>
                                        <td>{{$row->slug}}</td>
