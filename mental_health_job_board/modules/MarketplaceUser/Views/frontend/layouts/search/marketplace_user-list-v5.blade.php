        ...
        <div class="title-outer">
            ...
            <ul class="page-breadcrumb">
                <ul class="page-breadcrumb">
                    ...
                    @if(!empty($category))
                        <li><a href="{{ route("job.search") }}">{{ __("MarketplaceUsers") }}</a></li>
                        <li>{{ $category->name }}</li>
            ...
            <div class="content-column col-lg-12">
                <div class="ls-outer">
                        ...
                        <div class="row">
                            @if($rows->count() > 0)
                            @foreach($rows as $row)
                                <div class="marketplace_user-block-three col-lg-6 col-md-12 col-sm-12">
                                    @include("MarketplaceUser::frontend.layouts.loop.item-v1")
                                </div>
                            @endforeach
                            @else
                                <div class="col-12">
                                    <h3 class="text-center">{{ __("No marketplace_user results found") }}</h3>
                                </div>
                            @endif
