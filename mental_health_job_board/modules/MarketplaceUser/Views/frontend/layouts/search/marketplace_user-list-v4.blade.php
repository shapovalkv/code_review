...
{{--                    @endif--}}
            ...
            <div class="content-column col-lg-8 col-md-12 col-sm-12">
                <div class="ls-outer">
                    <button type="button"
                            class="theme-btn btn-style-two toggle-filters">{{ __("Show Filters") }}</button>
                    ...
                    @if(!empty($rows) && count($rows) > 0)
                        ...
                        @foreach($rows as $row)
                            <div class="marketplace_user-block-three">
                                @include("MarketplaceUser::frontend.layouts.loop.item-v1")
                            </div>
                        @endforeach
