<div class="sidebar-widget">
    <div class="widget-content">
        <ul class="job-overview">
            ...
            @if($row->user->phone && is_applied($row->id))
                <li>
                    <i class="icon flaticon-phone" style="color: #007bff"></i>
                    <h5>{{__('Telephone Number')}}:</h5>
                    <span>{{ $row->user->phone }}</span>
                </li>
            @endif

            @if($row->user->email && is_applied($row->id))
                <li>
                    <i class="icon flaticon-email" style="color: #007bff"></i>
                    <h5>{{__('Email')}}:</h5>
...
{{--                    <li><a target="_blank" href="{{ route('marketplace_user.index', ['skill' => $skill->id]) }}">{{ $trans->name }}</a></li>--}}
{{--                @endforeach--}}
{{--            </ul>--}}
{{--        </div>--}}
{{--    </div>--}}
...
{{--            <!--Comment Form-->--}}
{{--            <form method="post" action="{{ route("marketplace_user.contact.store") }}"  class="bravo-contact-block-form">--}}
