...
@section('content')
    @include('MarketplaceUser::frontend.layouts.search.'. $style)
@endsection
...
@section('footer')
    ...
    <script type="text/javascript"
            src="{{ asset('module/marketplace_user/js/marketplace_user-map.js?_ver='.config('app.asset_version')) }}"></script>
    <script>
        jQuery(".view-more").on("click", function () {
            jQuery(this).closest('ul').find('li.tg').toggleClass("d-none");
            jQuery(this).find('.tg-text').toggleClass('d-none');
