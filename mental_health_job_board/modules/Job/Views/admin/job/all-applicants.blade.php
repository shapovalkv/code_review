                                                    ...
                                                    <div class="dropdown">
                                                        ...
                                                        <div class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownMenuButton">
                                                            @if($row->candidateInfo)
                                                                <a class="dropdown-item" href="{{ route('candidate.detail', ['candidate' => $row->candidateInfo->id ]) }}">{{ __("View Candidate Profile") }}</a>
                                                            @endif
                                                            <a class="dropdown-item" href="#" data-toggle="modal" data-target="#modal-applied-{{ $row->id }}">{{ __("Details") }}</a>
                                                            <a class="dropdown-item" href="{{ route('job.admin.applicants.changeStatus', ['status' => 'approved', 'id' => $row->id]) }}">{{ __("Approve") }}</a>
                                                            <a class="dropdown-item" href="{{ route('job.admin.applicants.changeStatus', ['status' => 'rejected', 'id' => $row->id]) }}">{{ __("Reject") }}</a>
                                                        </div>
                                                    </div>
