        ...
        <div class="panel">
            <div class="panel-body">
                <div class="form-group">
                    <label class="" >{{__("Job Title Page")}}</label>
                ...
                <div class="form-group">
                    <label class="" >{{__("Practicum Title Page")}}</label>
                    <div class="form-controls">
                        <input type="text" name="job_practicum_page_search_title" value="{{setting_item_with_lang('job_practicum_page_search_title',request()->query('lang'),$settings['job_practicum_page_search_title'] ?? __("Practicum sites"))}}" class="form-control">
                    </div>
                </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-4">
                                                    <select class="form-control" name="job_sidebar_search_fields[{{$key}}][type]">
                                                        ...
                                                        <option value="employment_type" @if(!empty($item->type) && $item->type=='employment_type') selected @endif>{{__("Employment Type")}}</option>
                                                    </select>
                                                </div>
                                                <div class="col-md-2">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-4">
                                                <select class="form-control" __name__="job_sidebar_search_fields[__number__][type]">
                                                    ...
                                                    <option value="employment_type">{{__("Employment Type")}}</option>
                                                </select>
                                            </div>
                                            <div class="col-md-2">
                ...
                <div class="form-group">
                    ...
                    <div class="form-group-border p-3" style="border: 1px solid #ddd">
                        <div class="form-group">
                            ...
                            <div class="form-controls">
                                <input type="text" name="job_sidebar_cta[title]" value="{{ $job_sidebar_cta->title ?? "" }}" class="form-control">
                            </div>
                        </div>
                        <div class="form-group">
