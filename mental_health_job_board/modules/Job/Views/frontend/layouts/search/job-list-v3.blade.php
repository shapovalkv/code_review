...
{{--                                <a href="{{ ($job_sidebar_cta->button->url) }}"--}}
{{--                                   target="{{ $job_sidebar_cta->button->target ?? "_self" }}"--}}
{{--                                   class="theme-btn btn-style-one bg-blue">--}}
{{--                                    <span--}}
{{--                                        class="btn-title">{{ $job_sidebar_cta->button->name ?? __("Start Recruiting Now") }}</span>--}}
{{--                                </a>--}}
{{--                            @endif--}}
{{--                            <div class="image"--}}
{{--                                 style="background-image: url({{ !empty($job_sidebar_cta->image) ? \Modules\Media\Helpers\FileHelper::url($job_sidebar_cta->image, 'full') : '' }});"></div>--}}
{{--                        </div>--}}
{{--                        <!-- End Call To Action -->--}}
{{--                    @endif--}}
                </div>
