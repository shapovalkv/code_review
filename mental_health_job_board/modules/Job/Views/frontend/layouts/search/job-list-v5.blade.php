    ...
    <div class="auto-container">
        <div class="title-outer">
            @if(Route::currentRouteName() == 'job.search.practicum')
                <h1>{{ !empty(setting_item_with_lang('job_practicum_page_search_title')) ? setting_item_with_lang('job_practicum_page_search_title') : __("Practicum Sites") }}</h1>
            @else
...
{{--                        <li><a href="{{ route("job.search") }}">{{ __("Jobs") }}</a></li>--}}
{{--                        <li>{{ $location->name }}</li>--}}
{{--                    @elseif(Route::currentRouteName() == 'job.search.practicum')--}}
{{--                        <li>{{ __("Practicum sites") }}</li>--}}
{{--                    @else--}}
{{--                        <li>{{ __("Jobs") }}</li>--}}
{{--                    @endif--}}
{{--                </ul>--}}
                ...
                <div class="ls-outer">
                    @if(!empty($rows) && count($rows) > 0)
                        ...
                        <div class="ls-switcher">
                            ...
                            <div class="sort-by">
                                <form class="bc-form-order" method="get" action="{{ Route::currentRouteName() == 'job.search.practicum' ? route('job.search.practicum') : route('job.search')}}">
