...
Route::get('/export','JobController@export')->name('job.admin.export');
...
Route::get('/position','JobPositionController@index')->name('job.admin.position.index');
Route::get('/position/getForSelect2','JobPositionController@getForSelect2')->name('job.admin.position.getForSelect2');
Route::get('/position/edit/{id}','JobPositionController@edit')->name('job.admin.position.edit');
Route::post('/position/store/{id}','JobPositionController@store')->name('job.admin.position.store');
Route::post('/position/bulkEdit','JobPositionController@bulkEdit')->name('job.admin.position.bulkEdit');
