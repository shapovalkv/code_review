            ...
            <div id="cdn-browser" class="cdn-browser d-flex flex-column" v-cloak :class="{is_loading:isLoading}">
                ...
                <div class="files-nav flex-shrink-0">
                    <div class="d-flex justify-content-between">
                        ...
                        <div class="col-right mr-md-5 mr-sm-5 mr-lg-5 m-auto">
                            ...
                            <button class="btn btn-success btn-pick-files">
                                ...
                                <input multiple accept="image/png,image/jpeg,image/gif,image/bmp,image/svg,image/x-icon" type="file" name="files[]" ref="files">
                            </button>
                        </div>
                    </div>
                    <div class="text-right text-sm-center m-sm-auto">
                        <p>Supported formats: png, jpeg, gif, bmp, svg, ico</p>
                        <p>The file should not exceed 5 mb</p>
                    </div>
                </div>
