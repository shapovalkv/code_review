...
class CartManager
{
     ...
     */
    public static function update($cart_item_id,$qty = 1,$price = false, $meta = [], $variant_id = false, ?int $promocodeId = null){
        ...
        if($find){
            ...
            if(!is_null($promocodeId)){
                $find->promocode_id = $promocodeId;
            }
    ...
    public static function order(): Order
    {
        ...
        foreach ($items as $item){
            ...
            $order_item->promocode_id = $item->promocode_id ?? null;
            ...
            if ($item->promocode_id) {
                $order_item->promocode->users()->attach($userId);
            }
        }
        $order->syncTotal();
