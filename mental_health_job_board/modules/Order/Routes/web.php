...
Route::group(['prefix'=>'checkout','middleware'=>'auth'],function(){
    ...
    Route::post('/promocode','CheckoutController@promocode')->name('checkout.promocode');
});
...
Route::group(['prefix'=>'order'],function(){
    ...
    Route::get('/announcement/{id}','OrderController@announcementDetail')->name('order.announcement.detail')->middleware('auth');
});
