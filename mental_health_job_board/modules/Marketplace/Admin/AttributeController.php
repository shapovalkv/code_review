...
class AttributeController extends AdminController
{
    ...
    public function index(Request $request)
    {
        ...
        $listAttr = $this->attributesClass::where("service", 'Marketplace');
        ...
        return view('Marketplace::admin.attribute.index', $data);
    }
    ...
    public function edit(Request $request, $id)
    {
        ...
        $data = [
            ...
            'rows' => $this->attributesClass::where("service", 'Marketplace')->get(),
            'row' => $row,
            'breadcrumbs' => [
                [
                    'name' => __('Marketplace'),
                ...
                [
                    'name' => __('Attributes'),
                    'url' => route('marketplace.admin.attribute.index')
                ],
                [
        ...
        return view('Marketplace::admin.attribute.detail', $data);
    }
    ...
    public function getForSelect2(Request $request)
    {
        ...
        if ($pre_selected && $selected) {
            if (is_array($selected)) {
                $query = $this->termsClass::getForSelect2Query('Marketplace');
        ...
        $q = $request->query('q');
        $query = $this->termsClass::getForSelect2Query('Marketplace', $q);
