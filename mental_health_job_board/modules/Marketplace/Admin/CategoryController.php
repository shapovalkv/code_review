...
class CategoryController extends AdminController
{
    ...
    public function index(Request $request)
    {
        ...
        return view('Marketplace::admin.category.index', $data);
    }
    ...
    public function edit(Request $request, $id)
    {
        ...
        if (empty($row)) {
            return redirect(route('marketplace.admin.category.index'));
        }
        ...
        return view('Marketplace::admin.category.detail', $data);
    }
