...
use Modules\Marketplace\Models\MarketplaceCategoryTranslation;
use Modules\Marketplace\Models\MarketplaceCategoryType;
...
class CategoryTypeController extends AdminController
{
    ...
    public function __construct()
    {
        ...
        $this->categoryClass = MarketplaceCategoryType::class;
    }

    public function index(Request $request)
    {
        $this->checkPermission('marketplace_manage_others');
        ...
        $data = [
            ...
            'translation' => new MarketplaceCategoryTranslation(),
            'breadcrumbs' => [
                [
        ...
        return view('Marketplace::admin.category_type.index', $data);
    }
    ...
    public function edit(Request $request, $id)
    {
        ...
        if (empty($row)) {
            return redirect(route('marketplace.admin.category_type.index'));
        }
        ...
        return view('Marketplace::admin.category_type.detail', $data);
    }
