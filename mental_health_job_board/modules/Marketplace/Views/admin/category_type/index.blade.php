...
@section('content')
    <div class="container-fluid">
        <div class="d-flex justify-content-between mb20">
            <h1 class="title-bar">{{__("Marketplace Category Type")}}</h1>
        </div>
        ...
        <div class="row">
            <div class="col-md-4 mb40">
                <div class="panel">
                    ...
                    <div class="panel-body">
                        <form action="{{route('marketplace.admin.category_type.store',['id'=>($row->id) ? $row->id : '-1','lang'=>request()->query('lang')])}}" method="post">
                            @csrf
                            @include('Marketplace::admin/category_type/form',['parents'=>$rows])
                            <div class="">
            ...
            <div class="col-md-8">
                <div class="filter-div d-flex justify-content-between ">
                    <div class="col-left">
                        @if(!empty($rows))
                            <form method="post" action="{{route('marketplace.admin.category_type.bulkEdit')}}" class="filter-form filter-form-left d-flex justify-content-start">
                                {{csrf_field()}}
                        ...
                        <form class="bravo-form-item">
                            <table class="table table-hover">
                                ...
                                <tr>
                                    ...
                                    <th>{{__("Name")}}</th>
                                    <th class="d-none d-md-table-cell">{{__("Marketplace Category")}}</th>
                                ...
                                @if( count($rows) > 0)
                                    ...
                                    <tr>
                                        ...
                                        <td class="title">
                                            <a href="{{route('marketplace.admin.category_type.edit',['id'=>$row->id])}}">{{$row->name}}</a>
                                        </td>
