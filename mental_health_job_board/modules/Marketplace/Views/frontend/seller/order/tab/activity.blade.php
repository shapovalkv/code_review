...
@if(($order->status == \Modules\Marketplace\Models\MarketplaceOrder::IN_PROGRESS || $order->status == \Modules\Marketplace\Models\MarketplaceOrder::IN_REVISION) && !$order->orderExpired())
    <div class="button-group text-center mt-4">
        <a class="theme-btn btn-style-one bg-blue bc-seller-delivery" href="#">{{ __("Delivery Order") }}</a>
        @include('Marketplace::frontend.elements.delivery-popup')
    </div>
@endif
