@php
    ...
    $delivery_count = 0;
@endphp
<div class="bc-order-panel @if($order->status == \Modules\Marketplace\Models\MarketplaceOrder::COMPLETED || $order->status == \Modules\Marketplace\Models\MarketplaceOrder::CANCELLED) bc-order-completed @endif">
        ...
        @if($order->activities)
            @foreach($order->activities as $key => $activity)
                ...
                @switch($activity['type'])
                    @case(\Modules\Marketplace\Models\MarketplaceOrderActivity::TYPE_REQUIREMENTS)
                        ...
                        @break
                    @case(\Modules\Marketplace\Models\MarketplaceOrderActivity::TYPE_ORDER_STARTED)
                        ...
                        @break
                    @case(\Modules\Marketplace\Models\MarketplaceOrderActivity::TYPE_DELIVERY_DATE)
                        ...
                        @break
                    @case(\Modules\Marketplace\Models\MarketplaceOrderActivity::TYPE_DELIVERED)
                        ...
                        <div id="activity-{{ $activity->id }}" class="activity-item delivered">
                            ...
                            <div class="item-body">
                                ...
                                <div class="message-body">
                                    @include('Marketplace::frontend.elements.delivery-item')
                                </div>
                            </div>
                        </div>
                        @break
                    @case(\Modules\Marketplace\Models\MarketplaceOrderActivity::TYPE_REVISION)
                                            ...
                                            <div class="activity-item user-message">
                                                ...
                                                <div class="item-body">
                                                    ...
                                                    <div class="message-body">
                                                        ...
                                                        @include('Marketplace::frontend.elements.attachments')
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                        ...
                        @break
                    @case(\Modules\Marketplace\Models\MarketplaceOrderActivity::TYPE_ORDER_COMPLETED)
    ...
    @if($order->status == \Modules\Marketplace\Models\MarketplaceOrder::COMPLETED || $order->status == \Modules\Marketplace\Models\MarketplaceOrder::CANCELLED)
...
@if($order->status == \Modules\Marketplace\Models\MarketplaceOrder::DELIVERED)
    <div class="button-group text-center mt-4">
        ...
        @if(!$order->orderExpired())
            ...
            @include('Marketplace::frontend.elements.revision-popup')
        @endif
    </div>
@endif
