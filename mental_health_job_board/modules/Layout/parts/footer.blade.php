...
<script src="{{ asset('module/superio/js/jquery.ui.touch-punch.min.js') }}"></script>
...
<script src="{{ asset('libs/fireworks/fireworks.js') }}"></script>
<script src="{{ asset('libs/inputmask/inputmask.js') }}"></script>
