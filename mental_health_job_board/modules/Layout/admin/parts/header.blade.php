...
<div class="header-logo flex-shrink-0">
    <h3 class="logo-text" style="font-size: 18px"><a href="{{url('/admin')}}">{{__('Mental Healthcare Careers')}}</a></h3>
</div>
    ...
    <div class="widgets-right flex-shrink-0 d-flex">
        ...
        @endif
            <div class="dropdown header-widget widget-user pt-2 dropdown-notifications flex-shrink-0" style="min-width: 0">
                <a href="{{route('user.admin.support.index')}}" class="user-dropdown d-flex align-items-center text-black">
                    <i class="fa fa-lg fa-life-ring m-1 p-1 text-black"></i>
                    @if($countNewSupport)<span class="badge badge-danger notification-icon">{{$countNewSupport}}</span>@endif
                </a>
            </div>
        <div class="dropdown header-widget widget-user pt-2 dropdown-notifications flex-shrink-0" style="min-width: 0">
            <div data-toggle="dropdown" class="user-dropdown d-flex align-items-center" aria-haspopup="true" aria-expanded="false">
                <i class="fa fa-lg fa-bell m-1 p-1"></i>
                @if($countUnread)<span class="badge badge-danger notification-icon">{{$countUnread}}</span>@endif
            </div>
