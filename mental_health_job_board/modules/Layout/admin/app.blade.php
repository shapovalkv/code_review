...
<head>
    ...
    <title>{{ $page_title ?? 'Dashboard'}} - {{setting_item('site_title') ?? 'Mental Healthcare Careers'}}</title>
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-6 copy-right" >
                        {{date('Y')}} &copy; {{__('Mental Healthcare Careers by')}} <a href="{{__('https://www.superio.bookingcore.org')}}" target="_blank">{{__('Mental Healthcare Careers Team')}}</a>
                    </div>
                    <div class="col-md-6">
