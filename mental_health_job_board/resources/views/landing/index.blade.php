                ...
                <div class="col-sm-9 col-xs-12">
                    <div class="flex-middle-sm justify-end">
                        ...
                        <div class="buy pull-right hidden-xs">
                            <a class="btn btn-theme-second pull-right" target="_blank" href="https://codecanyon.net/item/superio-laravel-job-board-system/33973038">Purchase Now</a>
                        </div>
                    </div>
                </div>
            </div>
...
<div id="wrapper">
    <div class="main-content">
            ...
            <div class="topheader-inner">
                <div class="container text-center">
                    ...
                    <div class="button-top">
                        <a href="#home-pages" class="btn btn-white">View Demos</a>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div id="home-pages" class="section1 home-pages">
            <div class="container">
                <div class="top-wrapper text-center">
                    <h2 class="text-theme number-homes">09+</h2>
                ...
                <div class="row row-90">
                    ...
                    <div class="col-xs-12 col-md-4 col-sm-6 wow slideInLeft">
                        <div class="wrap-img wrap-img ">
                            <a class="img-bg" href="{{ url('/page/home-page-7') }}" target="_blank">
                                <img src="{{ asset('landing') }}/images/home-7.png">
                            </a>
                            <h3 class="title-demo"><a href="{{ url('/page/home-page-7') }}">Demo 7</a></h3>
                        </div>
                    </div>
                    <div class="col-xs-12 col-md-4 col-sm-6 wow slideInLeft">
                        <div class="wrap-img wrap-img ">
                            <a class="img-bg" href="{{ url('/page/home-page-8') }}" target="_blank">
                                <img src="{{ asset('landing') }}/images/home-8.png">
                            </a>
                            <h3 class="title-demo"><a href="{{ url('/page/home-page-8') }}">Demo 8</a></h3>
                        </div>
                    </div>
                    <div class="col-xs-12 col-md-4 col-sm-6 wow slideInLeft">
                        <div class="wrap-img wrap-img ">
                            <a class="img-bg" href="{{ url('/page/home-page-9') }}" target="_blank">
                                <img src="{{ asset('landing') }}/images/home-9.png">
                            </a>
                            <h3 class="title-demo"><a href="{{ url('/page/home-page-9') }}">Demo 9</a></h3>
                        </div>
                    </div>
                </div>
        ...
        <div id="listing" class="section1">
            <div class="container">
                <div class="top-wrapper text-center">
                    <h2 class="number text-white">09+</h2>
            ...
            <div class="container-fluid">
                <div class="max-850">
                    <div class="slick-class slick-class-style st-white">
                        ...
                        <div><a class="img-listing" href="{{ url('/job?_layout=v4') }}" target="_blank"><img src="{{ asset('landing') }}/images/l3.jpg"></a></div>
                        <div><a class="img-listing" href="{{ url('/job?_layout=v5') }}" target="_blank"><img src="{{ asset('landing') }}/images/l4.jpg"></a></div>
                        <div><a class="img-listing" href="{{ url('/job?_layout=v6') }}" target="_blank"><img src="{{ asset('landing') }}/images/l8.jpg"></a></div>
                        <div><a class="img-listing" href="{{ url('/job?_layout=v7') }}" target="_blank"><img src="{{ asset('landing') }}/images/l9.jpg"></a></div>
                        <div><a class="img-listing" href="{{ url('/job?_layout=v8') }}" target="_blank"><img src="{{ asset('landing') }}/images/l11.jpg"></a></div>
                        <div><a class="img-listing" href="{{ url('/job?_layout=v9') }}" target="_blank"><img src="{{ asset('landing') }}/images/l13.jpg"></a></div>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="row flex-middle-sm">
                    ...
                    <div class="col-xs-12 col-sm-6">
                        <div class="slick-class slick-class-style">
                            ...
                            <div><a class="img-listing" href="{{ url('job/product-designer-ui-designer?_layout=v3') }}" target="_blank"><img src="{{ asset('landing') }}/images/d3.jpg"></a></div>
                            <div><a class="img-listing" href="{{ url('job/product-designer-ui-designer?_layout=v4') }}" target="_blank"><img src="{{ asset('landing') }}/images/d4.jpg"></a></div>
                            <div><a class="img-listing" href="{{ url('job/product-designer-ui-designer?_layout=v5') }}" target="_blank"><img src="{{ asset('landing') }}/images/d5.jpg"></a></div>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="footer-inner">
            <div class="container">
                <div class="text-center">
                    ...
                    <a class="btn btn-theme-second" target="_blank" href="https://codecanyon.net/item/superio-laravel-job-board-system/33973038">Buy Now</a>
                    <div class="footer-bottom">Powered By Made with love by Bookingcore</div>
                </div>
            </div>
        </div>
